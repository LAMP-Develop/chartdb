...
ARG VITE_SHARED_DIAGRAMS_URL
ARG VITE_LIVE_SYNC_URL
...
RUN echo "VITE_OPENAI_API_KEY=${VITE_OPENAI_API_KEY}" > .env && \
    ...
    echo "VITE_SHARED_DIAGRAMS_URL=${VITE_SHARED_DIAGRAMS_URL}" >> .env && \
    echo "VITE_LIVE_SYNC_URL=${VITE_LIVE_SYNC_URL}" >> .env
